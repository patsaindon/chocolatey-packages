...
function global:au_BeforeUpdate($Package) {
    ...
    # internal packages, alongside temurin17) and was never retrofitted
    # with this hook, which every package scaffolded since has had. Same
    # bug and same fix as temurin17.
    #
